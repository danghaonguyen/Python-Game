...
WHITE = (255, 255, 255)
RED = (213, 50, 80)
YELLOW = (255, 255, 0)  # Thay đổi màu thức ăn thành vàng
BLUE = (50, 153, 213)
BLACK = (0, 0, 0)

# Khởi tạo cửa sổ game
screen = pygame.display.set_mode((WIDTH, HEIGHT))
pygame.display.set_caption("🐍 Python Game - Snake by Haonguyen 🐍")
...
def game_loop():
    ...
    while not game_over:
        while game_close:  # Khi Game Over
            screen.fill(BLACK)
            ...
            for event in pygame.event.get():
                ...
                if event.type == pygame.KEYDOWN:
                    if event.key == pygame.K_r:  # Nhấn R để restart
                        game_loop()
        ...
        # Vẽ màn hình game
        screen.fill(BLACK)
        pygame.draw.rect(screen, YELLOW, [food_x, food_y, BLOCK_SIZE, BLOCK_SIZE])  # Thức ăn màu vàng
        ...
        for block in snake_body[:-1]:
            if block == snake_head:
                game_close = True  # Kích hoạt màn hình Game Over
